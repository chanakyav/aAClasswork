...
user3 = User.create!(username: 'kelly')
user4 = User.create!(username: 'kelly ku')
...
artwork3 = Artwork.create!(title: 'van gogh', image_url: 'google2.com', artist_id: user3.id) 
ArtworkShare.create!(artwork_id: artwork1.id, viewer_id: user1.id) #, favorite: true)
